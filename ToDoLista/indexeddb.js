var DatabaseManager = /** @class */ (function () {
  ...
  DatabaseManager.prototype.createObject = function (
    storeName,
    databaseElement
  ) {
    var _this = this;
    ...
    createRequest.onerror = function () {
      return _this.errorHandler(storeName, _this.CREATE_OBJECT);
    };
  };
  DatabaseManager.prototype.getObject = function (storeName, id, callback) {
    ...
    getRequest.onerror = function () {
      return _this.errorHandler(storeName, _this.READ_OBJECT);
    };
  ...
  DatabaseManager.prototype.getAllObjects = function (storeName, callback) {
    ...
    getAllRequest.onsuccess = function () {
      return callback(getAllRequest.result);
    };
  ...
  DatabaseManager.prototype.deleteObject = function (storeName, id) {
    ...
    addRequest.onerror = function () {
      return _this.errorHandler(storeName, _this.DELETE_OBJECT);
    };
  };
  DatabaseManager.prototype.editObject = function (storeName, databaseElement) {
    ...
    updateRequest.onerror = function () {
      return _this.errorHandler(_this.databaseName, _this.UPDATE_OBJECT);
    };
  };
  DatabaseManager.prototype.dangerousDropDatabase = function () {
    ...
    deleteRequest.onerror = function () {
      return _this.errorHandler(_this.databaseName, _this.DELETE_OBJECT);
    };
  };
  DatabaseManager.prototype.initDB = function (databaseObjects) {
    ...
    openRequest.onerror = function () {
      return console.warn("Error loading " + _this.databaseName + " database!");
    };
    openRequest.onupgradeneeded = function () {
      return _this.handleOnUpgradeNeeded(openRequest, databaseObjects);
    };
    openRequest.onsuccess = function () {
      return _this.handleOnSuccessOpenRequest(openRequest);
    };
  };
  DatabaseManager.prototype.handleOnSuccessOpenRequest = function (
    openRequest
  ) {
    this.database = openRequest.result;
  };
  DatabaseManager.prototype.handleOnUpgradeNeeded = function (
    openRequest,
    databaseStores
  ) {
    var _this = this;
